...
async def delete_messages(user_id, client): #delete messages in reverse order
    for message_id, channel_id in user_msg_channel_binder[user_id][::-1]:
        try:
    ...
    user_msg_channel_binder[user_id] = [] #reset user's msg list
